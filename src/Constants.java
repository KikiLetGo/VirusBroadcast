...
public class Constants {
    ...
    public static float SHADOW_TIME = 1;//潜伏时间，14天为140
    ...
    public static float FATALITY_RATE = 0.02f;//fatality_rate病死率，根据2月6日数据估算（病死数/确诊数）
    public static int DIE_TIME = 300;//死亡时间均值，30天，从发病（确诊）时开始计时
